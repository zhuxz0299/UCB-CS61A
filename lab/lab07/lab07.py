...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    cur_grade,assign_grade=0,0
    def stu(assign,stu_grade):
        nonlocal cur_grade,assign_grade
        cur_grade+=stu_grade
        assign_grade+=class_assignments[assign]
        return cur_grade/assign_grade
    return stu
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    #version2
    list_num_trees=[0,1]
    while(len(list_num_trees)-1<n):
        # print("DEBUG:list_num_trees={}".format(list_num_trees))
        new_num=0
        for i in range(1,len(list_num_trees)):
            new_num+=list_num_trees[i]*list_num_trees[len(list_num_trees)-i]
        list_num_trees.append(new_num)
    return list_num_trees[n]
    ...
    def advanced_counter_maker():
        ...
        def advanced_counter(instr):
            ...
            if instr=='count':
                ...
                local_counter=0
            elif instr=='global-count':
                global_counter+=1
                return global_counter
            elif instr=='global-reset':
                global_counter=0
